...
#define CMD_DIGIT 0x53
#define CMD_DRAW 0x54
#define CMD_CLEAR 0x55
...
public:
    ...
    void SetChar(char c, char bias_x, char bias_y, uint8_t r, uint8_t g, uint8_t b)
    {
        // send command uint8_t
        Wire.beginTransmission(m_addr);
        Wire.write((uint8_t)CMD_DIGIT);
        Wire.write(c);
        Wire.write(bias_x);
        Wire.write(bias_y);
        Wire.write(r);
